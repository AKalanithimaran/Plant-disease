...
def model_prediction(test_image):
    ...
    model = tf.keras.models.load_model('C:\\Users\\kalanithi\\Documents\\Plant-Disease-Detection-main\\Plant-Disease-Detection-main\\my_model_saved.h5')
...
if(app_mode=="Home"):
    ...
    st.image(image_path, caption='Plant Disease', use_container_width=True)
    st.markdown("""
...
#     model = tf.keras.models.load_model('my_model_saved.h5')  # Change this path if necessary
...
#         # Prediction
#         if st.button("Predict"):
#             st.snow()  # Snow effect while predicting
#             try:
...
#                 # Nutritional information for healthy crops
#                 nutrition_map = {
#                     'Apple___healthy': "High in fiber, vitamin C, and antioxidants.",
#                     'Blueberry___healthy': "High in antioxidants, vitamin C, and dietary fiber.",
#                     'Cherry_(including_sour)___healthy': "High in antioxidants, vitamin C, and potassium.",
#                     'Corn_(maize)___healthy': "Rich in carbohydrates, fiber, and vitamins.",
#                     'Grape___healthy': "Rich in antioxidants, vitamin C, and fiber.",
...
#                 # If the predicted class is a healthy plant, show nutritional information
#                 if predicted_class in nutrition_map:
#                     st.write("Edible")
#                     st.write("Nutritional Information:")
#                     st.write(nutrition_map[predicted_class])
                
#                 # Fertilizer treatment for diseases
#                 treatable_diseases = {
#                     'Apple___Apple_scab': ["Nitrogen", "Phosphorus", "Potassium"],
#                     'Apple___Black_rot': ["Nitrogen", "Calcium", "Magnesium"],
#                     # Add more treatable diseases...
#                 }
                
#                 if predicted_class in treatable_diseases:
#                     st.write("Edible")
#                     st.write("Treatment Recommendations:")
#                     st.write(f"Use the following fertilizers: {treatable_diseases[predicted_class]}")
#                 else:
#                     st.warning("Non-edible or no specific treatment.")
